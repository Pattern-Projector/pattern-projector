import { flipHorizontal, flipVertical, rotateMatrixDeg, transformPoint, translate } from "@/_lib/geometry";
...
export type LocalTransformAction = FlipAction | SetAction | RotateAction | RecenterAction | ResetAction;

export default function localTransformReducer(localTransform: Matrix, action: LocalTransformAction) {
  switch (action.type) {
    case "set": {
